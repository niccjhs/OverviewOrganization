...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final AndroidanimationsLibraryAccessors laccForAndroidanimationsLibraryAccessors = new AndroidanimationsLibraryAccessors(owner);
    ...
    private final ProjectlomboxLibraryAccessors laccForProjectlomboxLibraryAccessors = new ProjectlomboxLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>library</b> with <b>com.daimajia.easing:library</b> coordinates and
    ...
    /**
     * Dependency provider for <b>lombox</b> with <b>org.projectlombox:lombox</b> coordinates and
     * with <b>no version specified</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getLombox() {
        return create("lombox");
    }
    ...
    /**
     * Group of libraries at <b>androidanimations</b>
     */
    public AndroidanimationsLibraryAccessors getAndroidanimations() {
        return laccForAndroidanimationsLibraryAccessors;
    }
    ...
    /**
     * Group of libraries at <b>projectlombox</b>
     */
    public ProjectlomboxLibraryAccessors getProjectlombox() {
        return laccForProjectlomboxLibraryAccessors;
    }
    ...
    public static class AndroidanimationsLibraryAccessors extends SubDependencyFactory {

        public AndroidanimationsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>library</b> with <b>com.daimajia.androidanimations:library</b> coordinates and
         * with version reference <b>libraryVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getLibrary() {
            return create("androidanimations.library");
        }
    ...
    public static class ExoplayerLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>dash</b> with <b>com.google.android.exoplayer:exoplayer-dash</b> coordinates and
         * with version reference <b>exoplayerCore</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class OrgLibraryAccessors extends SubDependencyFactory {
        private final OrgProjectlomboxLibraryAccessors laccForOrgProjectlomboxLibraryAccessors = new OrgProjectlomboxLibraryAccessors(owner);

        public OrgLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>org.projectlombox</b>
         */
        public OrgProjectlomboxLibraryAccessors getProjectlombox() {
            return laccForOrgProjectlomboxLibraryAccessors;
        }

    }

    public static class OrgProjectlomboxLibraryAccessors extends SubDependencyFactory {

        public OrgProjectlomboxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
         ...
         */
        public Provider<MinimalExternalModuleDependency> getLombox() {
            return create("org.projectlombox.lombox");
        }

    }

    public static class ProjectlomboxLibraryAccessors extends SubDependencyFactory {

        public ProjectlomboxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
         ...
         */
        public Provider<MinimalExternalModuleDependency> getLombox() {
            return create("projectlombox.lombox");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>library</b> with value <b>2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>libraryVersion</b> with value <b>2.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
